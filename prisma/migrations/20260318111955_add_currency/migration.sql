...
CREATE TABLE "audot_log" (
    ...
    CONSTRAINT "audot_log_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ledger_entry" ADD CONSTRAINT "ledger_entry_transactionId_fkey" FOREIGN KEY ("transactionId") REFERENCES "transactions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
